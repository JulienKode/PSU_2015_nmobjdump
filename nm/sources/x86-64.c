/*
** x86-64.c for Nm by karst_j in /home/karst_j/psu_2015_nmobjdump/nm/sources/
**
** Made by Julien Karst
** Login   <karst_j@epitech.eu>
**
** Started on  Sun Feb 28 11:32:58 2016 Julien Karst
** Last update Sun Feb 28 14:01:14 2016 Julien Karst
*/
...
int			make_64bits(t_data *data)
{
  ...
  if (good_elf_64(data) == -1)
    error_open_file("nm: %s: File format not recognized\n"
		    , data->data64.file);
